...
class YoutubeFullScreenBuilder extends StatefulWidget {
  ...
  @override
  _YoutubeFullScreenBuilderState createState() => _YoutubeFullScreenBuilderState();
}
...
/// An inherited widget to provide [YoutubeFullScreenBuilder] to it's descendants.
class InheritedFullScreenBuilder extends InheritedWidget {
  /// Creates [InheritedYoutubePlayer]
  const InheritedFullScreenBuilder({
    Key key,
    @required Widget child,
})  : super(key: key, child: child);

  @override
  bool updateShouldNotify(InheritedFullScreenBuilder oldWidget) =>
      oldWidget.hashCode != this.hashCode;
}